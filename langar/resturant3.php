...
<body>
    <div style="background-image:url('https://bigseventravel.com/wp-content/uploads/2019/11/Screenshot-2019-11-15-at-15.12.00.png');
     background-repeat: no-repeat;  
     width:99%;">
<div class="first">
 <a href="homelangar.php"><img src="https://1.bp.blogspot.com/-XH2Bombqg8E/XlC5QTkZvuI/AAAAAAAAAQ4/IHJmZda6tEoed70j1HN_t_T5luccg4e8QCNcBGAsYHQ/s200/logo.jpg.jpeg" style="margin: 10px; height: 100px;"></a>
 </div>
 <br> <br>
 <div style="font-size: 28px; margin-left: 1000px;">
 <span >
   <a href="homelangar.php" style="text-decoration: none; color:white;">HOME</a>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logout.php" style=" color:white; text-decoration: none;">LOGOUT</a>
 </span>
 <br> <br> <br> <br>
</div>
<h1 style="font-size: 70px; text-align: center;color:white; font-weight: 300; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; ">
 <strong>VEGGIE INDIA</strong> 
</h1>
<h2 style="font-size: 25px; text-align: center; color:rgb(7, 3, 194); font-weight: 300; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif ">
    <strong>Near Hazira Market,Gwalior</strong> 
</h2>
<h4 style="font-size: 25px; text-align: center; color:skyblue; font-weight: 300; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif ">
    <strong>Your Happiness Is Our Concern </strong> 
</h4>
 <!-- code for display rating -->
 <?php
  
  $get_av_rate = "SELECT `rate_num`,`av_rate` FROM `rating` WHERE r_id='3'";
  ...
  ?>
   <center>
      <div style="width:210px; height:40px; background-color:black; padding;5px; border-radius:10px;">
...
<center><h1>MENU</h1></center>
 ...
 $food= "SELECT`r_id`,`f_id`, `name`, `tagline`, `image`, `price` FROM `food` WHERE r_id=3 order by f_id ASC ";
 ...
 <img src="<?php echo $fooditem['image']  ?>" style=" margin-top:10px; margin-left:50px; margin-right:300px;margin-bottom:0px;width:500px;height:180px; float:left;"/>
    ...
    <?php $fid= $fooditem['f_id']; 
      ...
      ?>
     <form action="addcart3.php?f_id=<?php echo $fid  ?>" method="post" >
     <input type ="text"  name = "quantity" placeholder="quantity" style="padding-top:5px;padding-bottom:5px;padding-left:20px;background-color:white;border:2px solid black;border-radius:5px;">
